...
**권한 매핑 정책:** 각 메뉴 1+개 권한과 N:M 매핑(`menu_permission`). UNION-match 가시성. 그룹 헤더(parent)는 자식 표시 여부로 cascade.

| 도메인 그룹 | 권한 | ADMIN | MANAGER | DEVELOPER | HR | VIEWER |
|---|---|:-:|:-:|:-:|:-:|:-:|
| Knowledge 7 (FAQ/용어집/HR/온보딩/도구/퀴즈×2) | `knowledge:read` | ✓ | ✓ | ✓ | ✓ | ✓ |
| Projects 자식 3 (비콘/이력/모듈) | `project:read` | ✓ | ✓ | ✓ | ✗ | ✓ |
| Infra 런북 | `infra:read` | ✓ | ✓ | ✓ | ✗ | ✓ |
| 스케줄 | `schedule:read` | ✓ | ✓ | ✓ | ✓ | ✓ |
| 유지보수 배정 | `maintenance:read` | ✓ | ✓ | ✓ | ✗ | ✓ |
| 유지보수 통계 | `maintenance:stats-read` | ✓ | ✓ | ✓ | ✓ | ✓ |
| 월간 리포트 | `month-report:read` | ✓ | ✓ | ✓ | ✓ | ✓ |
| Contractors 자식 2 (휴가/일정) | `contractor:read` | ✓ | ✓ | ✓ | ✓ | ✓ |
| Sales 그룹 22 (대시보드/계약/영업기회/활동/차트 등) | `sales:all` | ✓ | ✓ | ✗ | ✗ | ✗ |
| Admin 그룹 19 (사용자/조직/감사/회사/문서번호/FAQ/인프라 라이선스/임포트 등) | `admin:all` | ✓ | ✗ | ✗ | ✗ | ✗ |
