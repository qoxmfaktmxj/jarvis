...
|------|----------------------|---------------|
| [`.claude/skills/jarvis-architecture/SKILL.md`](.claude/skills/jarvis-architecture/SKILL.md) | 모노레포 레이아웃 · 6-lane 라우터 · page-first · wiki-fs SSoT · **영향도 체크리스트(17계층)** · **파일 변경 순서 20단계** · **검증 게이트 명령** | 거의 항상(진입점) |
