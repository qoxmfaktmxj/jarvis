  ...
  ↓
{
  ...
  ↓
OpenAI GPT-4-mini (configurable via ASK_AI_MODEL)
  ↓
...
| 영역 | 기술 |
|------|------|
| **AI 생성** | OpenAI (`gpt-4.1-mini` default, via `ASK_AI_MODEL` env var) |
...
| `ASK_AI_MODEL` | 아니오 | Ask AI 모델 (기본값: `gpt-4.1-mini`) |
...
5. OpenAI (기본: gpt-4.1-mini) 모델로 답변 생성
6. `[source:N]` 기반 출처 추출
...
export ASK_AI_MODEL=gpt-4.1-mini
