"use client";
/**
 * A2 P0-3/P0-4: isAdmin prop wired from page (Sales.Opportunities.Memo i18n applied).
 * - Delete buttons render for any memo when isAdmin is true; otherwise only m.isOwn.
 * - Server `deleteOpportunityMemo` still verifies admin/owner — UI hint only.
 */
...
export function MemoModal({
  ...
  const t = useTranslations("Sales.Opportunities.Memo");
