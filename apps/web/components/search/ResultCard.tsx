...
export function ResultCard({ hit }: ResultCardProps) {
  ...
  return (
    <article className="group relative rounded-md border border-(--border-default) bg-(--bg-surface) p-4 transition-all hover:-translate-y-[1px] hover:ring-1 hover:ring-(--brand-primary)/20 hover:shadow-[0_6px_20px_-8px_rgba(28,77,167,0.18)]">
