    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-60 hover:opacity-100 hover:bg-(--bg-page) rounded-md",
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-(--fg-primary) hover:bg-(--bg-page) rounded-md",
        ),
