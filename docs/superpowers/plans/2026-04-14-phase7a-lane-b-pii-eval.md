...
## Task 15: Root `package.json` scripts entry
...
- [ ] **Step 3: PR URL을 spec §9 Revision log에 추가**

```
| 2026-04-XX | PR#3+PR#6 Lane B 머지 | <PR URL> |
```
