...
const MENU_SEEDS: MenuSeed[] = [
  ...
  { code: "nav.project-beacons", kind: "menu", label: "비콘관리", icon: "RadioTower", routePath: "/projects/beacons", sortOrder: 201, permissions: [PERMISSIONS.PROJECT_READ, PERMISSIONS.ADMIN_ALL], keywords: ["비콘", "beacon", "project"] },
  { code: "nav.project-history", kind: "menu", label: "프로젝트수행이력", icon: "History", routePath: "/projects/history", sortOrder: 202, permissions: [PERMISSIONS.PROJECT_READ, PERMISSIONS.ADMIN_ALL], keywords: ["수행이력", "history", "project"] },
  { code: "nav.project-modules", kind: "menu", label: "프로젝트모듈관리", icon: "Package", routePath: "/projects/modules", sortOrder: 203, permissions: [PERMISSIONS.PROJECT_READ, PERMISSIONS.ADMIN_ALL], keywords: ["모듈", "module", "project"] },
