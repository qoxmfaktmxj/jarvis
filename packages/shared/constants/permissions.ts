export const PERMISSIONS = {
  ...
  // Phase-TSVD999 (2026-05-03): Service Desk + Month Report
  SERVICE_DESK_IMPORT: "service-desk:import",
  MAINTENANCE_STATS_READ: "maintenance:stats-read",
  MONTH_REPORT_READ: "month-report:read",
  MONTH_REPORT_WRITE: "month-report:write",
...
export const ROLE_PERMISSIONS: Record<string, Permission[]> = {
  ...
  MANAGER: [
    ...
    PERMISSIONS.SERVICE_DESK_IMPORT,
