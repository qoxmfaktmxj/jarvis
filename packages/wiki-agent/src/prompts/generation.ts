...
const SYSTEM_RULES = [
  ...
  "기존 위키는 한국어·영어 혼용이다. 본문은 소스 언어를 따르되, 고유명사는 원문 표기를 유지한다.",
  "",
  "## Title Language Rule (CRITICAL)",
  "",
  "- frontmatter의 `title` 필드는 **반드시 한국어**로 작성한다.",
  "- 영문 고유명사(제품명, 기술 용어, 인명 등)는 괄호로 병기한다: \"마인드볼트(MindVault) 개요\", \"연차 휴가 정책\".",
  "- 소스가 영어여도 title은 한국어로 번역한다. 예: \"Annual Leave Policy\" → \"연차 휴가 정책\".",
  "- Current Wiki Index에 영어 title이 있더라도 새로 생성하는 페이지의 title은 반드시 한국어로 작성한다.",
  "- aliases에는 영어 원문 title을 포함하여 검색성을 보장한다.",
  "",
  ...
  "```yaml",
  "---",
  "title: \"페이지 제목 (영문 고유명사가 있으면 괄호 병기)\"",
