---
title: "무신고 가산세 20% (부정 40%)"
slug: withholding-employee-local-tax-penalty-nonfiling-f-lt0014
pageType: guide
publishedStatus: published
sources:
  - sourceRevisionId: "{{sourceRevisionId:withholding-tax-verified-facts.json}}"
    locator: fact-f-lt0014
...
종업원분 주민세를 무신고하면 산출세액의 20%(부정무신고는 40%)의 무신고 가산세가 부과된다(지방세기본법 제53조).
